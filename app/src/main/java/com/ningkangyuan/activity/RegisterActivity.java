...
//        mPasswordET.setText("xc123456");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.register_getcode:
                // " + getResources().getString(R.string.RegisterActivity_java_9)
                mAuthPhone = mPhoneET.getText().toString().trim();
                if (TextUtils.isEmpty(mAuthPhone)) {
                    ToastUtil.show(this, getResources().getString(R.string.RegisterActivity_java_11));
                    return;
                }
            ...
            case R.id.register_submit:
                // " + getResources().getString(R.string.RegisterActivity_java_14)
                submit();
                break;
        ...
        final TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mAuthcodeBTN.setText(" " + getResources().getString(R.string.RegisterActivity_java_16) + "(" + mCount + ")");
                        if (mCount == 0) {
                            mTimer.cancel();
                            mTimer = null;

                            mCount = 60;
                            mAuthcodeBTN.setText(getResources().getString(R.string.RegisterActivity_java_16));
    ...
    private void submit() {
        ...
        if (TextUtils.isEmpty(mIdCard)) {
            ToastUtil.show(this, getResources().getString(R.string.RegisterActivity_java_32));
            return;
        }
...
//        }
        ...
        if (TextUtils.isEmpty(authCode)) {
            ToastUtil.show(this, getResources().getString(R.string.RegisterActivity_java_39));
            return;
        }

        if (!mPhone.equals(mAuthPhone)) {
            ToastUtil.show(this, getResources().getString(R.string.RegisterActivity_java_41));
            return;
        }
            ...
            public void onResponse(Call call,  Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ToastUtil.show(RegisterActivity.this, message);
                        if ("1".equals(code)) {
                            // " + getResources().getString(R.string.RegisterActivity_java_70)
                            finish();
                        }
                    }
                });
