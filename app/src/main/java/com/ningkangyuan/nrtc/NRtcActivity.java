...
public class NRtcActivity extends AppCompatActivity {
    ...
    private void configFromPreference(SharedPreferences preferences) {
        ...
        audioReportSpeaker = preferences.getBoolean(getString(R.string.setting_voe_report_speaker_key), false);
    ...
    protected NRtcParameters getRtcParameters() {
        ...
        parameters.setBoolean(NRtcParameters.KEY_SESSION_LIVE_MODE, true);
