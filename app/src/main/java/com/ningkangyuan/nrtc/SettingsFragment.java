...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference(getString(R.string.setting_voe_report_speaker_key)).setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (runtime) {
            ...
            } else if (key.equals(getString(R.string.setting_voe_report_speaker_key))) {
                newSettings.put(NRtcParameters.KEY_AUDIO_REPORT_SPEAKER, newValue);
            }
